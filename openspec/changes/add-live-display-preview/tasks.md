...
- [ ] 6.4 Deploy, then confirm the panel's next capture is unchanged from the one before it (the extraction's real acceptance test) — **not done: waiting on the go-ahead, since this writes to the live wall chart**
