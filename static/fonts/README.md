...
| `inter-600.woff2`        | `@fontsource/inter` — `inter-latin-600-normal`            | 24K  |
...
| `inter-600-italic.woff2` | `@fontsource/inter` — `inter-latin-600-italic`            | 26K  |
...
`inter-600-italic.woff2` — emphasis is one weight step above body, not a fixed
700 (design.md D25-D27, `improve-bullet-legibility`), and body never exceeds
600 on this page. It was 500 briefly; measuring the raw capture rather than a
phone photo showed 500 never actually cleared the modal-stem boundary that
separates emphasis from body, on any bullet content tried (design.md D29-D30,
`strengthen-bullet-emphasis`).
...
cp node_modules/@fontsource/inter/files/inter-latin-600-normal.woff2 static/fonts/inter-600.woff2
...
cp node_modules/@fontsource/inter/files/inter-latin-600-italic.woff2 static/fonts/inter-600-italic.woff2
